...
import DetailSpecialty from './HomePage/Section/Speciatly/DetailSpecialty.js';
            ...
            <span className="content-container">
              <CustomScrollbars style={{ height: '100vh', width: '100%' }}>
                <Switch>
                  ...
                  <Route path={path.ALL_DIRECTORY} component={AllDirectory} />
                  <Route
                  ...
                  />
                  <Route path={path.CANCEL_BOOKING} component={CancelBooking} />
                </Switch>
              </CustomScrollbars>
            </span>
